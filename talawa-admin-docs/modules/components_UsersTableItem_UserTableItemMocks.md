...
[src/components/UsersTableItem/UserTableItemMocks.ts:6](https://github.com/chandel-aman/talawa-admin/blob/99e6195/src/components/UsersTableItem/UserTableItemMocks.ts#L6)
